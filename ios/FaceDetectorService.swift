...
public class FaceDetectorService: NSObject {
    ...
    public static func detectFeatures(_ frame: Frame!, withArgs args: [AnyHashable : Any]?) -> [ImageFaceFeatures]? {
    ...
    public static func detectFace(_ frame: Frame!, withArgs args: [AnyHashable : Any]?) -> [[String:Any]]? {
        ...
        for imageFeature in imageFeatures {
            ...
            result.updateValue(feature.angleX, forKey: "headEulerAngleX")
            result.updateValue(feature.angleY, forKey: "headEulerAngleY")
            result.updateValue(feature.angleZ, forKey: "headEulerAngleZ")
